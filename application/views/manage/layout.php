  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('manage') ?>" class="logo">
        ...
        <?php } else { ?>
          <span class="logo-lg pull-left"><img src="<?php echo media_url('img/logo.svg') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;Payment APP<!-- <?php echo $this->config->item('app_name') ?> --></b></span>
        <?php } ?>
      </a>
