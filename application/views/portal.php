...
<body>
	...
	<section class="content-section">
		<div class="container text-center">
			<div class="row">
				<div class="col-md-12">
					<h2><i class="fa fa-graduation-cap"></i> Selamat Datang</h2><br>
					<h3><p class="mb-5 colr"> Sistem Informasi Pembayaran Biaya Pendidikan Siswa</p></h3>
					<h3><p class="mb-5 colr"> SD Negeri Ujungalang 03 Kampung Laut </p></h3><br><br><br>
				</div>
				<div class="col-md-6">
