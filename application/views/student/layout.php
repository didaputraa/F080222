  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      ...
      <a href="<?php site_url('student') ?>" class="logo">
        ...
        <span class="logo-lg"><img src="<?php echo upload_url('school/' . logo()) ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;Payment APP<!-- <?php echo $this->config->item('app_name') ?> --></b></span>
        <?php } else { ?>
        <span class="logo-lg"><img src="<?php echo media_url('img/logo.svg') ?>" style="height: 40px; margin-top: 5px;" class="pull-left"><b>&nbsp;Payment APP<!-- <?php echo $this->config->item('app_name') ?> --></b></span>
        <?php } ?>
      </a>
    ...
    <?php 
	$data = isset($ajaran)?['ajaran' => $ajaran] : [];
