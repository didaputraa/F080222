				...
				<div class="box box-success">
					<div class="box-header">
						...
						<div class="row">
							...
							<a class="btn btn-success" target="_blank" href="<?php echo site_url('manage/report/report_bill_detail' . '/?' . http_build_query($q)) ?>"><i class="fa fa-file-pdf-o" ></i> Export PDF</a>
							<?php } ?>
						</div>
					</div>
					</div>
