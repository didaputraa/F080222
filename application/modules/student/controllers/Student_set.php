...
class Student_set extends CI_Controller {
  ...
  public function add($id = NULL) {
    ...
    $this->form_validation->set_rules('student_parent_phone', 'No. Handphone Orangtua', 'trim|required|alpha_numeric|xss_clean');
    $this->form_validation->set_rules('student_phone', 'No. Handphone', 'trim|required|alpha_numeric|xss_clean');
    $this->form_validation->set_rules('student_full_name', 'Nama lengkap', 'trim|required|alpha|xss_clean');
    $this->form_validation->set_rules('student_name_of_mother', 'Nama Ibu kandung', 'trim|required|alpha|xss_clean');
    $this->form_validation->set_rules('student_name_of_father', 'Nama Ayah kandung', 'trim|required|alpha|xss_clean');
